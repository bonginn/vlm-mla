# This file is copied from MHA2MLA/src/mha2mla/patching_model_load.py
# Original source: MHA2MLA repository
import torch
...
def reorder_matrix_rows(mask, is_cat=False):
    ...
    Args:
        ...
        is_cat: If True, return concatenated indices. If False, return separate indices for ones and zeros.

    Returns:
        The reordered indices
    """
...
def patch_model(model, model_args, mha2mla_args):
    ...
    Args:
        model: The language model (e.g., LlamaForCausalLM)
        model_args: Model configuration arguments
        mha2mla_args: MHA2MLA configuration arguments
